  ...
  return (
    <div className="bg-blue-500">
      <nav className="relative px-4 py-4 flex justify-between items-center bg-white">
        ...
        {user ? (
          <div className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-xl text-gray-900 font-bold rounded-xl transition duration-200 ">
          ...
          <div className="mt-auto">
            <div className="pt-6">
              {user ? (
                <button
                  onClick={logout}
                  className="block px-4 py-3 mb-3 leading-loose text-xs text-center font-semibold leading-none bg-gray-50 hover:bg-gray-100 rounded-xl cursor-pointer"
                >
                  Logout
                </button>
              ) : (
